        ...
        <div className="max-w-4xl mx-auto bg-slate-800/50 backdrop-blur-sm rounded-lg border border-slate-700/50 p-8">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-gray-300 mb-4">
              ...
              sign up for our beta waitlist, or contact us for support.
            </p>
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">Analytics and Tracking</h2>
            <p className="text-gray-300 mb-4">
              We use analytics tools including PostHog to help us understand how users interact with 
              our service. These tools may collect information about your device and usage patterns 
