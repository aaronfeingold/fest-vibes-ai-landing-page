        ...
        <div className="max-w-4xl mx-auto bg-slate-800/50 backdrop-blur-sm rounded-lg border border-slate-700/50 p-8">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-gray-300 mb-4">
              By accessing and using Fest-Vibes, you accept and agree to be bound by the terms 
              and provision of this agreement.
            </p>
            
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">Description of Service</h2>
            <p className="text-gray-300 mb-4">
              Fest-Vibes is a platform that helps users discover local music events, plan music 
              experiences, and connect with other music enthusiasts. Our service includes planning 
              tools, event discovery, and social features.
            </p>
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">Beta Testing</h2>
            <p className="text-gray-300 mb-4">
              Our service is currently in beta. Features may change, and the service may experience 
              downtime or interruptions. Beta users understand that the service is provided "as is" 
              during this testing period.
            </p>
            
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">Prohibited Uses</h2>
            <p className="text-gray-300 mb-4">
              You may not use our service for any unlawful purpose or to violate any laws. You agree 
              not to use the service to harass, abuse, or harm other users.
            </p>
            
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">Limitation of Liability</h2>
            <p className="text-gray-300 mb-4">
              Fest-Vibes shall not be liable for any indirect, incidental, special, consequential, 
